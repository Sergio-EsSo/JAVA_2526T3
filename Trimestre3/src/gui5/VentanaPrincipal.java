...
public class VentanaPrincipal extends JFrame implements ActionListener {
	...
	private JMenuItem itemMenu1, itemMenu2; // items
	...
	public void actionPerformed(ActionEvent evento) {
		...
		if (evento.getSource() == itemMenu2) { /* Se selecciona el ítem de menú 2 */
			try {
				...
				int numero = Integer.valueOf(númeroHabitación); /* Se convierte el texto ingresado a int */
				if (numero < 1 || numero > 10) {
					...
					ventanaSalida.setVisible(true); /* Se visualiza la ventana de salida del huésped */
							 ...
							 * Si la habitación no está ocupada, se muestra un
							 * mensaje de error
							 */
