...
public class test2 {
    ...
    // Si AMBOS son IGUALES es porque no me di cuenta de que hicimos un test2 y 
    // sobreescribí todo en el test1
	...
	public static void main(String[] args) {
        ...
        // VER TODOS LOS DATOS
        System.out.println("nTodos los integrantes muestran su INFO. (Todos ejecutan el mismo método)");
		for (SeleccionFutbol integrante : integrantes) {
